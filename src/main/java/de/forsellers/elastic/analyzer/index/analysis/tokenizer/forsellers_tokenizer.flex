 ...
 */
@Override public final void GetMatchedText(CharTermAttribute t) {
...
// Any punctuation allowed in number formats.
P               = ("_"|"-"|"/"|"."|",")
...
// At least one digit
TIMES_NUM       = ({DIGIT}+)[xX]{DIGIT}+[LETTER]+
...
{TIMES_NUM}         { return TokenTypes.NUM; }

{HAS_DIGIT_WORD}    { return TokenTypes.HAS_DIGIT; }
